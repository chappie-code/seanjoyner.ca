		...
		function widget( $args, $instance ) {
			...
			if ( $date_arrival || $date_departure ) {
				...
				$script_args = array(
					...
					'script' => Plethora_Shortcode_Bookingcallto::get_datepicker_script(),
					'multiple' => false,
				);
			...
			if ( $rooms ) {
				...
				$fields[] = Plethora_Shortcode_Bookingcallto::get_field_config( $rooms_name, $rooms_title, Plethora_Shortcode_Bookingcallto::get_field_post_options( 'room' ), '', 'selected_room', '', $rooms_multiple ); 
			}
