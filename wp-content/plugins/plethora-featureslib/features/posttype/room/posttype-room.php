		...
		public function get_post_type_options( $type = 'names' ) {
			...
			if ( $type === 'names' ) {
				...
				$return = array(
					...
					'slug' 			 =>	 $this->post_type, 
					'menu_item_name' =>	 sprintf( esc_html_x('%ss', 'Room post type menu item', 'plethora-framework'), ucfirst( $this->post_type ) ),
					'singular' 		 =>  sprintf( esc_html_x('%s', 'Room post type singular label', 'plethora-framework'), ucfirst( $this->post_type ) ),
					'plural' 		 =>  sprintf( esc_html_x('%s', 'Room post type plural label', 'plethora-framework'), ucfirst( $this->post_type ) ),
