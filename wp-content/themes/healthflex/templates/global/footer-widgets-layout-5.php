...
?>
<div class="col-sm-4"><?php dynamic_sidebar( $sidebar_one ); ?></div>
<div class="col-sm-4"><?php dynamic_sidebar( $sidebar_two ); ?></div>
<div class="col-sm-4"><?php dynamic_sidebar( $sidebar_three ); ?></div>