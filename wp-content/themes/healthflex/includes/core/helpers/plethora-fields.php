...
abstract class Plethora_Fields {
	...
	*/
	...
	public function wp_enqueue_scripts() {
		...
		wp_enqueue_script( 'plethora-fields', PLE_CORE_JS_URI . '/plethora-fields.js', array( 'jquery', 'jquery-ui-core' ), false, true );
	...
	public function wp_enqueue_styles() {
		...
		wp_enqueue_style( 'plethora-fields', PLE_CORE_JS_URI . '/plethora-fields.css', array( 'jquery', 'jquery-ui-core' ), false, true );
